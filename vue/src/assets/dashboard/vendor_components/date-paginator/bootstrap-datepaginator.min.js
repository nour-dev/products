        ...
        (o.prototype = {
                ...
                (this.options = t.extend({}, o.defaults, e)),
                    ...
                    "string" == typeof this.options.selectedDate &&
                        (this.options.selectedDate = moment(
                            ...
                            .clone()
                            .startOf("day")),
                    this.options.selectedDate.isBefore(
                        this.options.startDate
                    ) &&
                        (this.options.selectedDate =
            ...
            _subscribeEvents: function () {
                this._unsubscribeEvents(),
                    this.$element.on(
                        "click",
                        t.proxy(this._clickedHandler, this)
                    ),
            ...
            _clickedHandler: function (e) {
                ...
                -1 != s.indexOf("dp-nav-left")
                    ...
                    ? this._forward()
                    : -1 != s.indexOf("dp-item") &&
                      this._select(i.attr("data-moment"));
            },
            ...
            _forward: function () {
                this._setSelectedDate(
                    this.options.selectedDate.clone().add("day", 1)
                ),
                    this._render();
            },
            _select: function (t) {
                this._setSelectedDate(
                    moment(t, this.options.selectedDateFormat)
                ),
                    this._render();
            },
            ...
            _render: function () {
                ...
                this.$element.empty().append(this.$wrapper.empty()),
                    ...
                    this.$wrapper.append(
                        t(e._template.listItem).append(this.$leftNav)
                    ),
                    t.each(i.items, function (i, s) {
                        ...
                        s.isSelected &&
                            ...
                            s.isToday &&
                                e.options.highlightToday &&
                                a.addClass("dp-today"),
                            s.isStartOfWeek &&
                                e.options.showStartOfWeek &&
                                a.addClass("dp-divider"),
                            s.isOffDay &&
                                e.options.showOffDays &&
                                a.addClass("dp-off"),
                            s.isSelected &&
                                e.options.showCalendar &&
                                a.append(e.$calendar),
                            "sm" === e.options.size
                            ...
                            a.append(s.text),
                            e.$wrapper.append(
                                t(e._template.listItem).append(a)
                            );
                    }),
                    this.$rightNav
                    ...
                    this.$wrapper.append(
                        t(e._template.listItem).append(this.$rightNav)
                    ),
                    this.$calendar &&
                        (this.$calendar
                            .datepicker({
                            ...
                            .datepicker(
                                "update",
                                this.options.selectedDate.toDate()
                            ),
                        this.$calendar.on(
                            "changeDate",
            ...
            _buildData: function () {
                for (
                    var t =
                        ...
                        s = Math.floor(t / e),
                        a = Math.floor(
                            this.options.selectedItemWidth + (t - e * s)
                        ),
                        o = moment().startOf("day"),
                        n = this.options.selectedDate
                            .clone()
                            .subtract("days", i),
                        d = this.options.selectedDate
                            .clone()
                            .add("days", e - i),
                        p = {
                            isSelectedStartDate:
                                this.options.selectedDate.isSame(
                                    this.options.startDate
                                )
                                    ? !0
                                    : !1,
                    ...
                    var h =
                        ...
                        (r.isSame(this.options.endDate) ||
                            r.isBefore(this.options.endDate))
                            ? !0
                            : !1;
                    p.items[p.items.length] = {
                        m: r.clone().format(this.options.selectedDateFormat),
                        isValid: h,
                        isSelected: r.isSame(this.options.selectedDate)
                            ? !0
                            : !1,
                        ...
                        isStartOfWeek:
                            ...
                            this.options.startOfWeek
                                .split(",")
                                .indexOf(
                                    r.format(this.options.startOfWeekFormat)
                                )
                                ? !0
                                : !1,
                        text: r.format(
